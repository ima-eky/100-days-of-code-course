...
- In this script,our code researches houses thats fit a particular criteria for a client on the Zillow website.And then is going to be 
transferring that data from website into a form which will create a spreadsheet in Google sheets.
...
- Once all of the forms been compiled,you will have the option to turn it into a spreadsheet(Create a gooogle sheet from the responses submitted)
